...
- [x] Explain what a token is used for.
  ...
  - Token is used as a way to provide authentication from the client to the server
...
- [x] Describe how web servers work.
  ...
  - Web browser requests the web server, the web server serves the web page
...
- [ in progress ] Build a form at the bottom of `ColorList.js` to add new colors to the colors data
